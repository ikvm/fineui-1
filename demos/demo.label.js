    ...
    render() {
        return <HorizontalCenterLayout ref={ (wraper) => this.wraper = wraper } width={ 800 } style={ { color: '#ffffff' } }>
                 ...
                 <Label className='label-bg' whiteSpace='normal' height={ 60 } width={ 600 } textWidth={ 300 } textHeight={ 30 }
                   vgap={ 20 }>这是一个 label 组件,默认居中,whiteSpace为 normal,设置了宽度,高度,文字高度30,文字宽度.如果文字太长了的话,那么滚动条是很有必要的.不信你看.这是一个 label 组件,默认居中,whiteSpace为 normal,设置了宽度,高度,文字高度30,文字宽度.如果文字太长了的话,那么滚动条是很有必要的.不信你看</Label>
                 <Label className='label-bg' whiteSpace='normal' textAlign='right' height={ 100 } width={ 600 } textWidth={ 400 } vgap={ 20 }>这是一个 label 组件,默认居中,whiteSpace为 normal,设置了宽度,高度,文字宽度,没有文字高度,textAlign为right</Label>
                 <Label className='label-bg' whiteSpace='normal' height={ 60 } width={ 600 } textWidth={ 300 } vgap={ 20 }>这是一个 label 组件,默认居中,whiteSpace为 normal,设置了宽度,高度,文字宽度,没有文字高度,如果文字太长了,那么滚动条是很有不要的,不信你看.多加点字效果更明显一点,在多加点.more more more more more more more more more</Label>
                 ...
                 <Label className='label-bg' whiteSpace='normal' width={ 600 } height={ 60 } textHeight={ 30 } vgap={ 20 }>没有文字宽度,那么就撑满容器,whiteSpace为normal,textHeight=30 可以滚动的效果,多加点字效果更明显一点,在多加点.more more more more more more more more more more more more more more more more more more
                 ...
                 <Label className='label-bg' whiteSpace='normal' width={ 600 } height={ 60 } textHeight={ 30 } vgap={ 20 }>有高度,没有文字宽度,那么就撑满容器,whiteSpace为normal,textHeight=30 可以滚动的效果,多加点字效果更明显一点,在多加点.more more more more more more more more more more more more more more more more more
                   more more more more more more more more more more more more more more more more more more more more more more more more</Label>
                 ...
                 <Label className='label-bg' whiteSpace='normal' height={ 60 } vgap={ 20 }>设置高度,要是不给宽度的话,最大宽度就是容器宽度,所以就是被撑开嘛,但有高度所以不会无限扩张,超过高度了会出滚动条,不信你看,多加点字效果更明显一点,在多加点.more more more more more more more more moremore more more more more more more
                   more more more more more more more moremore more more more more more more more more more more more more more moremore more more more more more more more more
