...
class LabelDemo extends Component {
    ...
    render() {
        return <HorizontalCenterLayout ref={(wraper)=>this.wraper=wraper} width={800} style={{backgroundColor:'gray'}}>
            ...
            <Label textWidth={300} textHeight={30} vgap={20}>不设宽度,但是设置了 textwidth,textHeight=30 的效果</Label>
            ...
            <Label whiteSpace='normal' height={60} textHeight={30} vgap={20}>这是一个 label 组件,默认居中,whiteSpace为 normal,设置了高度,但没有宽度,文字高度30,如果文字太长了的话,那么滚动条是很有必要的.不信你看,多加点字效果更明显一点,在多加点.more more more more more more more more moremore more more more more more more more more</Label>
