...
import { VerticalLayout, AbsoluteLayout, Layout } from '../../core/layout'
...
class CollectionView extends PureComponent {
    ...
    render() {
        ...
        */
        ...
        //window.console.log(this.props.flag + ' ' + totalHeight + ' ' + height)
        ...
        const scrollx = (totalWidth + verticalScrollBarSize <= width) ? false : true
        ...
        return (
            ...
            */
            <Layout
                ...
                onScroll={this._onScroll}
                scrollable={scrollx && scrolly ? true : null}
                scrollx={scrollx}
                scrolly={scrolly}
                width={width}
                height={height}>
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        //window.console.log(prevProps.flag + ' didUpdate  ' + scrollTop);
        ...
        if (scrollPositionChangeReason === SCROLL_POSITION_CHANGE_REASONS.REQUESTED) {
            ...
            if (
                ...
                // window.console.log(this.props.flag + ' update scrollTop');
     ...
     */
    _setNextState(state) {
        //window.console.log(this.props.flag + ' setNextState');
        if (this._setNextStateAnimationFrameId) {
            cancelAnimationFrame(this._setNextStateAnimationFrameId)
        }
    ...
    _onScroll = (event) => {
        ...
        const scrollLeft = Math.max(0, Math.min(totalWidth - width + scrollbarSize, event.target.scrollLeft)) // totalWidth - (width - scrollbarSize)
        const scrollTop = Math.max(0, Math.min(totalHeight - height + scrollbarSize, event.target.scrollTop))

        //window.console.log(this.props.flag + ' scroll: ' + this.state.scrollTop + ' ' + scrollTop);
        // Certain devices (like Apple touchpad) rapid-fire duplicate events.
        // Don't force a re-render if this is the case.
        // The mouse may move faster than the animation frame does.
