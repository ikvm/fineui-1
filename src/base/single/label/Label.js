...
import { CenterLayout, Layout, HorizontalAdaptLayout, VerticalAdaptLayout, HorizontalCenterLayout, VerticalCenterLayout } from '../../../core/layout'
    ...
    _createCenterEl() {
        ...
        if (this._isValid(textWidth)) { //如果设置了文字宽度
            ...
            if (whiteSpace === 'normal') { //如果设置 normal,就涉及到换行的问题了,要给包裹文字的布局组件加上 whitespace
                ...
                return <Single className={ cn(CLASS_NAME, className) } scrolly={ true } {...props}>
                         <CenterLayout>
